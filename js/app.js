...
function handleBustError(img, size = 256) {
  if (!img.dataset.triedCount) {
    ...
    img.src = `https://visage.surgeplay.com/bust/${size}/8667ba71-b85a-4004-af54-4b3a9cde97e2`;
  } else if (img.dataset.triedCount === '1') {
    img.dataset.triedCount = '2';
    img.src = `https://crafatar.com/renders/bust/8667ba71-b85a-4004-af54-4b3a9cde97e2?size=${size}`;
  } else {
    img.onerror = null;
    img.src = `https://crafatar.com/avatars/8667ba71-b85a-4004-af54-4b3a9cde97e2?size=${size}`;
  }
}
...
function openPlayerModal(player) {
  ...
  const sources = [
    ...
    `https://crafatar.com/renders/body/${encodeURIComponent(cleanModalName)}?size=512&default=8667ba71-b85a-4004-af54-4b3a9cde97e2`,
    `https://minotar.net/armor/body/${encodeURIComponent(cleanModalName)}/512.png`,
    `https://visage.surgeplay.com/body/512/8667ba71-b85a-4004-af54-4b3a9cde97e2`,
    `https://crafatar.com/renders/body/8667ba71-b85a-4004-af54-4b3a9cde97e2?size=512`,
    `https://visage.surgeplay.com/bust/512/8667ba71-b85a-4004-af54-4b3a9cde97e2`
  ];
